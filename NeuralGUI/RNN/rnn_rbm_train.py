...
saved_weights_path = (sys.path[0] + '/parameter_checkpoints/initialized.ckpt') #The path to the initialized weights checkpoint file

def main(num_epochs, songList):
    ...
    songs = midi_manipulation.get_songs(songList) #Load the songs
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(num_epochs):
            ...
            if (epoch + 1) % epochs_to_save == 0:
                save_location = (sys.path[0] + "\parameter_checkpoints\epoch_{}.ckpt".format(epoch))
